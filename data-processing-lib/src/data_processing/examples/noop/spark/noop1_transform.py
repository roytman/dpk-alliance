...
from data_processing.examples.noop.python import NOOP1TransformConfiguration


logger = get_logger(__name__)


class NOOP1SparkTransformConfiguration(SparkTransformRuntimeConfiguration):
    """
...
if __name__ == "__main__":
    # create launcher
    launcher = SparkTransformLauncher(runtime_config=NOOP1SparkTransformConfiguration())
