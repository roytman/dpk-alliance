...
class SparkTransformLauncher(AbstractTransformLauncher):
    ...
    def __init__(
        ...
        data_access_factory: Union[DataAccessFactory, list[DataAccessFactory]] = DataAccessFactory(),
        orchestrator: type[SparkTransformOrchestrator] = SparkTransformOrchestrator,
    ):
        """
        Creates driver
        ...
        """
        super().__init__(
            runtime_config=runtime_config, data_access_factory=data_access_factory, orchestrator=orchestrator
        )
